...
public class HomeController {
	...
	public InfoDTO ajax_result01(@RequestBody InfoDTO dto) {
		...
		System.out.println("사용자가 넘겨준 값 : " + dto.getName() );
		System.out.println("사용자가 넘겨준 값 : " + dto.getAge() );
		
		dto.setName("서버에서 변경한 값");
		dto.setAge(30);
	...
	public Map ajax_result02(@RequestBody Map info) {
		...
		System.out.println("사용자가 넘겨준 값 : " + info.get("name") );
		System.out.println("사용자가 넘겨준 값 : " + info.get("age") );
		System.out.println("사용자가 넘겨준 값 : " + info.get("addr") );
